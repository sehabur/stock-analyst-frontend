        ...
        <AccordionDetails>
          <TableContainer component={Paper} elevation={0}>
            <Table size="small">
              ...
              <TableBody>
                {data?.gainer?.slice(0, 10).map((row: any) => (
                  <TableRow
                    key={row.id}
                    hover={true}
                    sx={{
        ...
        <AccordionDetails>
          <TableContainer component={Paper} elevation={0}>
            <Table size="small">
              ...
              <TableBody>
                {data?.loser?.slice(0, 10).map((row: any) => (
                  <TableRow
                    key={row.id}
                    hover={true}
                    sx={{
        ...
        <AccordionDetails>
          <TableContainer component={Paper} elevation={0}>
            <Table size="small">
              ...
              <TableBody>
                {data?.topVolume?.slice(0, 10).map((row: any) => (
                  <TableRow
                    key={row.id}
                    hover={true}
                    sx={{
        ...
        <AccordionDetails>
          <TableContainer component={Paper} elevation={0}>
            <Table size="small">
              ...
              <TableBody>
                {data?.topValue?.slice(0, 10).map((row: any) => (
                  <TableRow
                    key={row.id}
                    hover={true}
                    sx={{
        ...
        <AccordionDetails>
          <TableContainer component={Paper} elevation={0}>
            <Table size="small">
              ...
              <TableBody>
                {data?.topTrade?.slice(0, 10).map((row: any) => (
                  <TableRow
                    key={row.id}
                    hover={true}
                    sx={{
